    ...
    return(
        <div className={classes.userProfile}>
            <div className={[classes.card, 'card'].join(' ')}>
                <img src={user?(user.photoURL?user.photoURL:userImg):userImg}/>
                <div className="card-body">
                    <p className="card-title"> userName: {user?user.displayName:null}</p>
                    <p className="card-title"> Email: {user?user.email:null}</p>
